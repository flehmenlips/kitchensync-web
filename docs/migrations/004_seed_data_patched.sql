-- ============================================================================
-- KitchenSync Commercial Platform - Seed Data for Supabase (PATCHED)
-- ============================================================================
...
-- Coq au Vin hours (closed Mondays)
...
-- Bean & Leaf Cafe hours (individual inserts to avoid unnest issue)
-- Sunday (day 0) - 8am to 5pm
INSERT INTO business_hours (business_id, day_of_week, open_time, close_time, is_closed)
SELECT id, 0, '08:00', '17:00', FALSE FROM business_accounts WHERE slug = 'bean-leaf-cafe'
ON CONFLICT (business_id, day_of_week) DO NOTHING;

-- Monday (day 1) - 6:30am to 6pm
INSERT INTO business_hours (business_id, day_of_week, open_time, close_time, is_closed)
SELECT id, 1, '06:30', '18:00', FALSE FROM business_accounts WHERE slug = 'bean-leaf-cafe'
ON CONFLICT (business_id, day_of_week) DO NOTHING;

-- Tuesday (day 2) - 6:30am to 6pm
INSERT INTO business_hours (business_id, day_of_week, open_time, close_time, is_closed)
SELECT id, 2, '06:30', '18:00', FALSE FROM business_accounts WHERE slug = 'bean-leaf-cafe'
ON CONFLICT (business_id, day_of_week) DO NOTHING;

-- Wednesday (day 3) - 6:30am to 6pm
INSERT INTO business_hours (business_id, day_of_week, open_time, close_time, is_closed)
SELECT id, 3, '06:30', '18:00', FALSE FROM business_accounts WHERE slug = 'bean-leaf-cafe'
ON CONFLICT (business_id, day_of_week) DO NOTHING;

-- Thursday (day 4) - 6:30am to 6pm
INSERT INTO business_hours (business_id, day_of_week, open_time, close_time, is_closed)
SELECT id, 4, '06:30', '18:00', FALSE FROM business_accounts WHERE slug = 'bean-leaf-cafe'
ON CONFLICT (business_id, day_of_week) DO NOTHING;

-- Friday (day 5) - 6:30am to 6pm
INSERT INTO business_hours (business_id, day_of_week, open_time, close_time, is_closed)
SELECT id, 5, '06:30', '18:00', FALSE FROM business_accounts WHERE slug = 'bean-leaf-cafe'
ON CONFLICT (business_id, day_of_week) DO NOTHING;

-- Saturday (day 6) - 7am to 5pm
INSERT INTO business_hours (business_id, day_of_week, open_time, close_time, is_closed)
SELECT id, 6, '07:00', '17:00', FALSE FROM business_accounts WHERE slug = 'bean-leaf-cafe'
ON CONFLICT (business_id, day_of_week) DO NOTHING;
